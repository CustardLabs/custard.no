    ...
    <div class="col-md-8">
      <div class="row">
        <div class="col-sm-6">
          <h2>About us</h2>
          <p>
            Established in October 2014 in Oslo to bring focus to the exciting area of membership management systems. The company has since technically moved
            to Fredrikstad (by virtue of the company owner moving there!) but still works pretty much the same way, remotely and with periodic visits to a rented
            office in Oslo.
          </p>
          <p>
            We are a small team with an experienced affiliate network, allowing us to work on small or large projects and keep overhead costs low.
          </p>
        ...
        <div class="col-sm-6">
          ...
          <p>Backend development is mostly PHP based, using the popular Symfony framework.</p>
